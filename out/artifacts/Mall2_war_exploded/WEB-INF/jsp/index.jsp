				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotProductList }" var="hotProduct">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath }/product/productInfo?pid=${hotProduct.pid }&cid=${hotProduct.cid}&currentPage=1">
								<img src="/${hotProduct.pimage }" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath }/product/productInfo?pid=${hotProduct.pid }&cid=${hotProduct.cid}&currentPage=1" style='color:#666'>${hotProduct.pname }</a></p>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newProductList }" var="newProduct">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath }/product/productInfo?pid=${newProduct.pid }&cid=${newProduct.cid}&currentPage=1">
								<img src="/${newProduct.pimage }" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath }/product/productInfo?pid=${newProduct.pid }&cid=${newProduct.cid}&currentPage=1" style='color:#666'>${newProduct.pname }</a></p>
